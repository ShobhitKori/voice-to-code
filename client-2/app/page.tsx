    ...
    <>
      ...
      <div className="p-4 pt-6">
        <main className="grid grid-flow-row justify-items-center gap-4">
          ...
          {error && <p className="m-4 text-red-600 font-semibold w-full max-w-md mx-auto">Error: {error}</p>}
          ...
          {generateCode && (
            <div className="w-full max-w-3xl bg-gray-100 dark:bg-gray-900 p-4 rounded shadow text-sm overflow-auto">
              <div className="flex justify-between items-center mb-2">
                ...
                <button onClick={handleCopy} className="cursor-pointer text-sm px-2 py-1 transition">
                  {copied ? (
                    <>
              ...
              <code>
                <SyntaxHighlighter language="python" style={theme === "dark" ? oneDark : oneLight} wrapLongLines={true}>
                  {generateCode}
                </SyntaxHighlighter>
              </code>
            </div>
